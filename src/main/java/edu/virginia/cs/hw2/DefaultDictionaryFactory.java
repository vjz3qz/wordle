...
public class DefaultDictionaryFactory {
    private static final String DEFAULT_GUESSES_DICTIONARY_FILENAME = "/dictionary.txt";
    private static final String DEFAULT_ANSWERS_DICTIONARY_FILENAME = "/wordle_answers.txt";
